# MuSC_interactome.R
# source("C:/Users/sadeg/Google Drive/scRNA/muscle_scRNA/Analysis_scripts/Interactome/MuSC_interactome.R")
...
young_MuSC_interact <- cluster_interactome_rec(inx, inxNode, cluster_id = "2", age = "young")
...
if (nrow(young_MuSC_interact2 > 0)) {
	...
	young_MuSC_interact2[young_MuSC_interact2$cellTypeA == 5, "cellTypeA"] <- "FAP_3"
	young_MuSC_interact2[young_MuSC_interact2$cellTypeA == 6, "cellTypeA"] <- "Tenocyte"
	young_MuSC_interact2[young_MuSC_interact2$cellTypeA == 7, "cellTypeA"] <- "FAP_4"
	young_MuSC_interact2[young_MuSC_interact2$cellTypeA == 8, "cellTypeA"] <- "Schwann"
}
write.csv(young_MuSC_interact2, file = "C:/Users/sadeg/Google Drive/scRNA/Results/Interactome/young_MuSC_interact.csv")
