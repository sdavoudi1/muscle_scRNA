...
genes <- c("Cdh5", "Pecam1", "Pax7", "Cd34", "Ly6a", "Pdgfra", "Plp1", "Tnmd")
cluster_order <- c("EC_1", "EC_2", "MuSC", "FAP_1", "FAP_2", "FAP_3", "Schwann", "Tenocyte")
square_hmap_young_noimmune_v2 <- square_heatmap(young_noimmune_v2_labeled, genes = genes, cluster_order = cluster_order)
saveRDS(square_hmap_young_noimmune_v2, "C:/Users/sadeg/Google Drive/scRNA/data/young_aged/objects/graphs/young_noimmune_1gene_heatmap.RDS")