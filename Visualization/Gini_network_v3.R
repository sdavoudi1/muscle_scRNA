# source("C:/Users/sadeg/Google Drive/scRNA/muscle_scRNA/Visualization/Gini_network_v3.R")

network_graph <- function(x, dir_mode = "undirected") {
  ...
  colrs <- c("red", "orange", "cyan","green", "blue", "purple","gray40", "brown", "violet")
  ...
  plot.igraph(net,vertex.label=V(net)$name, edge.color=edge.col,edge.width=E(net)$weight/150,edge.curved= 0.1, layout=layout_as_star,edge.arrow.size=.4)
